...
- **Issue:** #7
- **Commit:** be403b3a96a8f802073b934182726a5016f44725
- **Generated:** 2026-09-06T05:41:37.979Z
- **Playwright:** 1.61.1
...
| AC-009-a | A foreign-currency expense is included in USD-denominated totals and category summaries | ✅ pass | `tests/e2e/specs/AC-009-a.spec.ts` | — |
| AC-009-b | The USD amount used for a foreign-currency expense reflects the exchange rate on that expense's logged date, not the current rate | ✅ pass | `tests/e2e/specs/AC-009-b.spec.ts` | — |
